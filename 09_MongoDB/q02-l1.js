...
// users 컬렉션에 username이 jones인 문서를 ㅡ저장하세요
...
//$set이 없으면 문서 전체를 변경할 문서를 덮어씌운다.
//MongoInvalidArgumentError: update 연산자 필요
//db.users.update({username: "smith"},{country:"Canada"});

//users 컬렉션에서 username이 smith인 문서를 {username: "smith", country: "Canada"}로
//대체하고 확인하세요.
//MongoInvalidArgumentError: update 연산자 필요
